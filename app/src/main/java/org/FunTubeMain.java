 ...
 * Main activity
 */
public class FunTubeMain extends Activity implements OnItemClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    VideoArrayAdapter adapter = new VideoArrayAdapter(this, R.layout.list_item, activities);
