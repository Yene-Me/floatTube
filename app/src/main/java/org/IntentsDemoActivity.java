...
public final class IntentsDemoActivity extends Activity implements OnItemClickListener {
  ...
  private List<ListViewItem> intentItems;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    intentItems = new ArrayList<ListViewItem>();
    ...
    VideoArrayAdapter adapter =
        new VideoArrayAdapter(this, R.layout.list_item, intentItems);
  ...
  private final class IntentItem implements ListViewItem {
