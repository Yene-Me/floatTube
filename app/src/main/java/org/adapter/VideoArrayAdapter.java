 ...
 */
public final class VideoArrayAdapter extends ArrayAdapter<ListViewItem> {

  private final LayoutInflater inflater;
  private int viewiD;

  public VideoArrayAdapter(Context context, int textViewResourceId, List<ListViewItem> objects) {
